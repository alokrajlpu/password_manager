...
const Manager = () => {
    ...
    return (
        <>
            <ToastContainer />
            <div style={{ backgroundImage: 'url("https://www.freepik.com/free-vector/shield_35202650.htm#query=lock&position=2&from_view=keyword&track=sph&uuid=c0aef861-d889-4d90-a599-7245296ab")', backgroundSize: 'cover', backgroundPosition: 'center' }}>
